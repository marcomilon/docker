...
sed "s#:mysql_tag#$mysql_tag#g" $base_dir/libraries/tmp/web-compose.yml.4 > $base_dir/libraries/tmp/web-compose.yml.5
sed "s#:mysql_container_name#$mysql_container_name#g" $base_dir/libraries/tmp/web-compose.yml.5 > $base_dir/libraries/tmp/web-compose.yml.6
sed "s#:mysql_root_password#$mysql_root_password#g" $base_dir/libraries/tmp/web-compose.yml.6 > $base_dir/libraries/tmp/web-compose.yml.7
sed "s#:phpmyadmin_tag#$phpmyadmin_tag#g" $base_dir/libraries/tmp/web-compose.yml.7 > $base_dir/libraries/tmp/web-compose.yml.8
sed "s#:phpmyadmin_container_name#$phpmyadmin_container_name#g" $base_dir/libraries/tmp/web-compose.yml.8 > $base_dir/libraries/tmp/web-compose.yml.9
sed "s#:phpmyadmin_port#$phpmyadmin_port#g" $base_dir/libraries/tmp/web-compose.yml.9 > $base_dir/compose/web-compose.yml
...
echo
read -p "Do you want to start Lamp now? [Y/n] " -n 1 -r
